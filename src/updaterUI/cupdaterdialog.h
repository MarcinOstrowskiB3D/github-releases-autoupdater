...
class CUpdaterDialog final : public QDialog,
                             private CAutoUpdaterGithub::UpdateStatusListener {
 public:
  explicit CUpdaterDialog(
      QWidget* parent,
      const QString&
 ...
 private:
  ...
  void onUpdateAvailable(
      const CAutoUpdaterGithub::ChangeLog& changelog) override;
